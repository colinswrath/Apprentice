...
class Shared.CenteredList extends MovieClip
{
	...
	var EntriesA: Array;
	var EntriesRaces: Array;
	var EntriesClasses: Array;
	var EntriesTraits: Array;
	...
	var iSelectedIndexRaces: Number;
	var iSelectedIndexClasses: Number;
	var iSelectedIndexTraits: Number;

	function CenteredList()
	{
		super();
		EntriesA = new Array();
		EntriesRaces = new Array();
        EntriesClasses = new Array();
        EntriesTraits = new Array();
		EventDispatcher.initialize(this);
		Mouse.addListener(this);
		iSelectedIndex = 0;
		iSelectedIndexRaces = 0;
        iSelectedIndexClasses = 0;
        iSelectedIndexTraits = 0;
	...
	function SwapToRaces()
	{
	  EntriesA = EntriesRaces;
	}
	function SwapToClasses()
	{
	  EntriesA = EntriesClasses;
	}
	function SwapToTraits()
	{
	  EntriesA = EntriesTraits;
	}
	function SaveRaceEntries()
	{
	  EntriesRaces = EntriesA;
	}
	function SaveClassEntries()
	{
	  EntriesClasses = EntriesA;
	}
	function SaveTraitEntries()
	{
	  EntriesTraits = EntriesA;
	}
	function ClearList()
	{
